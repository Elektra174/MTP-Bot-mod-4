...
6. **СОЗДАНИЕ ОБРАЗА** — Из телесного ощущения создать метафору:
   ...
   **ВАЖНО**: Если клиент описывает образ с ЭНЕРГИЕЙ внутри (например, "реактор с энергией", "прибор со светом", "контейнер с силой") — сразу предложи стать САМОЙ ЭНЕРГИЕЙ, а не внешней формой! Спроси: "А если бы ты мог стать не прибором, а самой этой энергией — как бы ты себя ощущал?" Энергия — это и есть ресурс, с которым мы работаем.
